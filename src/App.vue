<template>
  <div id="app">
    <img src="./assets/logo.svg" class="logo" alt="Aetna logo">
    <div class="container">
      <!-- <h1>Import your component here</h1> -->
        <Accordion v-for="(accordion, i) in accordionData" 
        :key="i" 
        :index="i" 
